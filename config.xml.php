...
<!-- REQUIRED, throws custom exception if missing -->
	<entry key="Password" value="o79Nz7envM"/>
...
<!-- optional, may be left out or empty - defaults to 'Default' -->
	<entry key="TemplatePublic" value="SMModernSpacious"/>
<!-- optional, may be left out or empty - defaults to 'Default' -->
	<entry key="TemplateAdmin" value="SMModernSpacious"/>
...
<!-- REQUIRED, Sitemagic Framework won't execute extensions if left out or empty -->
	<entry key="ExtensionsEnabled" value="SMAnnouncements;SMAutoSeoUrls;SMConfig;SMExtensionCommon;SMLogin;SMPages;SMMenu;SMFiles;SMContact;SMExternalModules;SMDesigner;SMComments;SMRating;SMTips;SMSearch;SMGoogleAnalytics;SMImageMontage"/>
